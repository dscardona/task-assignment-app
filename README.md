...
As indicated by its name, the task-assignment app allows users to match a number of participants to a set of tasks. The user must add participants and tasks to a database before the allocation of assignments takes place. All the tasks will be matched with a participant. Participant may be assigned to more than one task if the number of tasks exceeds the number of participants. If the number of participants is greater than the number of tasks, some participants will be spared from participating.
